...
class GenericTextField extends StatelessWidget {
  ...
  GenericTextField(
      ...
      required this.validate, this.min, this.maxLines});
  ...
  Widget buildFormFiled(BuildContext context) {
    return TextFormField(
      ...
      maxLines: maxLines!=null ?maxLines: fieldTypes == FieldTypes.chat
          ? null
      ...
      minLines: min,
      style: TextStyle(color: textColor ?? Color(0xff5B5B5B), fontSize: 12),
      ...
      decoration: WidgetUtils.setInputDecoration(
        ...
        fillColor: fillColor ?? MyColors.secondary,
        padding: contentPadding,
        hintColor: MyColors.textFieldHintColor,
